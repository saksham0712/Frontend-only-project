...
const OurClients = () => {
    return (
        <div className='w-full bg-white text-center flex flex-col justify-items-center gap-4'>
            ...
            <h3 className='text-gray-700 text-3xl md:text-5xl font-semibold mt-10'>Manage your entire community in a single system</h3>
            ...
            <div className="h-[90vh] w-full flex flex-col md:flex-row justify-around items-center">
                ...
                <div className="right w-auto md:w-[40vw] flex flex-col items-center md:items-start gap-6">
                    <div className='text-center md:text-start'>
                        <h1 className='text-gray-700 text-2xl md:text-4xl font-semibold'>The unseen of spending three years at Pixelgrade</h1>
                    </div>
                    <div className='text-center md:text-start'>
                        <p className='text-gray-800 mx-4 md:m-1'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet justo ipsum. Sed accumsan quam vitae est varius fringilla. Pellentesque placerat vestibulum lorem sed porta. Nullam mattis tristique iaculis. Nullam pulvinar sit amet risus pretium auctor. Etiam quis massa pulvinar, aliquam quam vitae, tempus sem. Donec elementum pulvinar odio.</p>
                    </div>
                    <div>
