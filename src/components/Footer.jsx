...
const Footer = () => {
    return (
        <div className='bg-[#263238] h-[100vh] md:h-[60vh] text-white flex flex-col md:flex-row items-center justify-around content-center'>
            ...
            <div className='w-full md:w-[60vw] grid grid-cols-2 md:grid-cols-3 gap-0 gap-y-8'>
                    ...
                    <div>
                        ...
                        <form className="max-w-md mx-auto">
                            ...
                            <div className="relative">
                                ...
                                <img type="submit" src={send} className="absolute end-0 bottom-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-4 py-2 w-[30%] md:w-16">
