      ...
      <nav className='bg-slate-100 h-auto '>
        <div className='flex flex-auto flex-wrap justify-between md:justify-around items-center text-center p-2' >
          ...
          <div className="buttons flex items-center hidden md:block">
            ...
            <button type="button" className="text-black hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2  dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 hover:text-white">Sign Up</button>
