...
const Section = () => {
    return (
        <>
            ...
            {/* this is section 7 */}
            <div className="bg-slate-100 h-[110vh] md:h-[90vh] w-full flex flex-col md:flex-row justify-around items-center">
                ...
                <div className="right w-auto md:w-[60vw] flex flex-col items-center md:items-start gap-6">
                    ...
                    <div>
                        ...
                        <p className='text-gray-700'>British Dragon Boat Racing Association</p>
                    </div>
            ...
            <div className='w-full bg-white text-center flex flex-col justify-items-center gap-4'>
                <h3 className='text-gray-700 text-3xl md:text-5xl font-semibold mt-10'>Caring is the new marketing</h3>
                <div className=' m-auto w-auto md:w-[50vw]'>

                    <p className='text-gray-700 text-center'>The Nexcent blog is the best place to read about the latest membership insights, trends and more. See who's joining the community, read about how our community are increasing their membership income and lot's more.​</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center justify-center mt-6">
                    <div className='flex flex-col relative items-center w-[80%] min-w-[26vw] m-auto py-6'>
                        ...
                        <div className='absolute flex flex-col items-center gap-4 bg-slate-100 text-center border rounded-lg bottom-[-5px] w-5/6'>
                            <h3 className='text-gray-700 text-large md:text-2xl font-semibold mt-5'>Creating Streamlined Safeguarding Processes with OneRen</h3>
                            <div className='flex gap-2'>

                                <h3 className='text-green-600 text-center'>Meet all customers</h3>
                                <img src={arrow} className='w-6 h-6' alt="arrow" />
                            </div>
