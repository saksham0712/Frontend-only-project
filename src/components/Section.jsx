...
const Section = () => {
    return (
        <>
            ...
            {/* this is section 7 */}
            <div className="bg-slate-100 h-auto my-6 py-4 md:h-[90vh] w-auto flex flex-col md:flex-row justify-around items-center">
            ...
            {/* section 8 */}
            <div className='h-auto my-5 md:h-[100vh] w-full bg-white text-center flex flex-col justify-items-center gap-4'>
